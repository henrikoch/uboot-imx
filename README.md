...
```
UBOOT_SRC = "https://gitlab.darix.pro/hd/uboot-imx.git;protocol=git"
SRCBRANCH = "variscite-devboard-dart-6ul" (or any other created branch)
SRCREV = "${AUTOREV}" (or the commit ID , ${AUTOREV} = latest commit)
```
...
* [VARISCITE - Customizing U-boot](http://variwiki.com/index.php?title=Yocto_Customizing_U-Boot&release=RELEASE_THUD_V1.1_DART-6UL) 
* [VARISCITE - U-boot features](http://variwiki.com/index.php?title=Yocto_U-Boot_4.1.15_features&release=RELEASE_THUD_V1.1_DART-6UL) 
